/*	
	...
	Authors :Shrihari Gajanan Danawe,Karan Raj Kakwani
*/
...
%token BREAK CASE CONTINUE DEFAULT DO IF ELSE FOR GOTO WHILE SWITCH SIZEOF TYPEDEF EXTERN STATIC   INLINE RESTRICT STRUCT UNION  CHAR SHORT INT LONG   FLOAT DOUBLE CONST VOLATILE VOID  RETURN ELLIPSIS RIGHT_ASSIGN LEFT_ASSIGN ADD_ASSIGN SUB_ASSIGN MUL_ASSIGN DIV_ASSIGN MOD_ASSIGN AND_ASSIGN XOR_ASSIGN OR_ASSIGN RIGHT_OP LEFT_OP INC_OP DEC_OP PTR_OP AND_OP OR_OP LE_OP GE_OP EQ_OP NE_OP
